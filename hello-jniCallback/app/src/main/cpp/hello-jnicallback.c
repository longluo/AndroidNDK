 ...
 * file located at:
 *
 *   hello-jniCallback/app/src/main/java/me/longluo/hellojnicallback/MainActivity.java
 */
JNIEXPORT jstring JNICALL
Java_me_longluo_hellojnicallback_MainActivity_stringFromJNI(JNIEnv *env,
                                                             jobject thiz) {
#if defined(__arm__)
...
JNIEXPORT jint JNICALL JNI_OnLoad(JavaVM *vm, void *reserved) {
    ...
    jclass clz =
            (*env)->FindClass(env, "me/longluo/hellojnicallback/JniHandler");
...
Java_me_longluo_hellojnicallback_MainActivity_startTicks(JNIEnv *env,
                                                          jobject instance) {
 ...
 */
JNIEXPORT void JNICALL Java_me_longluo_hellojnicallback_MainActivity_stopTicks(
